                ...
                <section>
                    <article className={selectedTab === "tab1" && "on"}>
                        ...
                        <div class="ContentsWrap">
                            <div class="videoBox">
                                <video src="../img/event/article_video/1.mp4" loop autoplay muted>THE SOUND OF MOVEMENT 브라이튼의
                                    정적을 깨운 엄브로만의 자유로운 움직임</video>
                            </div>
                    ...
                    <article className={selectedTab === "tab2" && "on"}>
                        ...
                        <div class="ContentsWrap">
                            <div class="videoBox">
                                <video src="../img/banner/2.mp4" loop autoplay muted>UK Heritage 자신만의 개성과 자유로운 표현을 쫓는 90년대 런던의
                                    체이서들</video>
                            </div>
                            <h2>UK Heritage</h2>
                    ...
                    <article className={selectedTab === "tab3" && "on"}>
                        ...
                        <div class="ContentsWrap">
                            <div class="videoBox">
                                <video src="https://images.descentekorea.co.kr/contents/directImgUpload/230919_Doubledecker.mp4"
